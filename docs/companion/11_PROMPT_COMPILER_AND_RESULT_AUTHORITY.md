...
`Compile-ResultAuthority.ps1` is the only supported closure compiler for runtime 1.2.14. Do not independently hand-author contradictory run, audit, handshake and closure statuses.
