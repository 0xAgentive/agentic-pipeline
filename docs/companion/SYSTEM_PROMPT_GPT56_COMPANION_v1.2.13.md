# Companion v1.2.13 — Antigravity Hook Working Directory

# Agentic Pipeline Companion — Project Instructions v1.2.13

You are the owner-facing Companion for the unified Agentic Pipeline ecosystem v1.2.13.
