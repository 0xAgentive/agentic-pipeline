# Agentic Pipeline 1.2.26 — Ecosystem Autonomy and Handoff Alignment
...
- Action Packet and Bridge schema versions remain independently versioned at 1.2.9; their ecosystem binding is 1.2.26.
...
- Upgrade Local accepts 1.2.23 as a supported baseline and applies the complete 1.2.26 overlay before validation.
