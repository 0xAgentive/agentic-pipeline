...
class CompanionExporter:
    ...
    def export(self):
        ...
        file_contents["RUNTIME_TARGET.json"] = json_bytes({
            "ecosystem_version": rt.get("ecosystem_version", "1.2.21"),
            "target_pipeline_package": rt.get("pipeline_package", "1.2.21"),
            "target_runtime": rt.get("runtime", "1.2.21"),
            "target_companion": rt.get("companion", "1.2.21"),
