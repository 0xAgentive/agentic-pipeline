<#
.SYNOPSIS
    Install-AntigravityCompanionHandoff.ps1 - Installer for Antigravity Companion Handoff v1.2.27
.DESCRIPTION
...
Write-Host "Installing Antigravity Companion Handoff v1.2.27" -ForegroundColor Cyan
Write-Host "==============================================" -ForegroundColor Cyan
