<#
.SYNOPSIS
    Uninstall-AntigravityCompanionHandoff.ps1 - Uninstaller for Antigravity Companion Handoff v1.2.27
.DESCRIPTION
...
Write-Host "Uninstalling Antigravity Companion Handoff v1.2.27" -ForegroundColor Cyan
Write-Host "================================================" -ForegroundColor Cyan
