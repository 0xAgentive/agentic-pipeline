...
if ([string]::IsNullOrWhiteSpace($OutputRoot)) {
  $OutputRoot = Join-Path $Root ".artifacts\companion\1.2.2"
}
New-Item -ItemType Directory -Force $OutputRoot | Out-Null
$ZipPath = Join-Path $OutputRoot "agentic_pipeline_companion_pack1.2.2.zip"
...
$PackRoot = Join-Path $TempRoot "agentic_pipeline_companion_pack1.2.2"
