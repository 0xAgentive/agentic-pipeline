...
required=(
  ...
  scripts/windows/companion/Test-CompanionPack-v1.2.9.ps1 scripts/windows/companion/Test-AutonomousConvergenceContracts.ps1 scripts/windows/Test-UnifiedEcosystemVersion.ps1
  scripts/bridge/companion_action_bridge.py scripts/bridge/Install-CompanionActionBridge.ps1
  integrations/companion-handoff-1.2.9/Update-AgenticContextHandoff-v1.2.9.ps1
