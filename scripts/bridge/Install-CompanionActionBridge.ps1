...
$TaskDescriptionBase = 'Imports validated Companion 1.2.15 JSON Action Packets from Downloads into registered Agentic Pipeline projects.'
...
if ([string]$InstalledManifest.package_version -ne $EcosystemVersion -or [string]$InstalledManifest.runtime_version -ne $EcosystemVersion) { throw 'Action Bridge requires an installed project runtime 1.2.15.' }
