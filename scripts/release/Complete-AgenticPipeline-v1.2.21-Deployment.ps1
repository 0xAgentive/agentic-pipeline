...
try {
  ...
  $RuntimeUpdater = Join-Path $RuntimePackage 'scripts\windows\Update-AgenticProjectRuntime-v1.2.21.ps1'
  ...
  $HandoffPackage = Find-PackageRoot -ExtractRoot $HandoffExtract -Marker 'Update-AgenticContextHandoff-v1.2.21.ps1'
  $HandoffUpdater = Join-Path $HandoffPackage 'Update-AgenticContextHandoff-v1.2.21.ps1'
  ...
  $Prepare = Join-Path $Repo 'scripts\release\Prepare-AgenticPipeline-Companion-v1.2.21.ps1'
  ...
  $Bootstrap = Join-Path $Repo 'scripts\release\Create-Companion-Restart-Bootstrap-v1.2.21.ps1'
  $BootstrapArguments = @{
    ProjectRoot = $Project
    PipelineRepo = $Repo
