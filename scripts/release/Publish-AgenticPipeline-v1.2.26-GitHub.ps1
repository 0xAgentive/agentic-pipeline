...
if ([string]($Version.package_version) -ne '1.2.26') { throw 'Local repository is not version 1.2.26.' }
$ReleaseTitle = "Agentic Pipeline 1.2.26 - $([string]$Version.release_name)"
...
$ReleaseZip = Join-Path $ArtifactRoot 'pipeline\agentic-pipeline-1.2.26.zip'
$CompanionZip = Join-Path $ArtifactRoot 'companion\agentic-companion-1.2.26.zip'
$RuntimeZip = Join-Path $ArtifactRoot 'runtime\agentic-project-runtime-1.2.26.zip'
$ActionBridgeZip = Join-Path $ArtifactRoot 'action-bridge\agentic-action-bridge-1.2.26.zip'
$HandoffCompatibilityZip = Join-Path $ArtifactRoot 'handoff-compatibility\agentic-context-handoff-1.2.26.zip'
...
$Notes = Join-Path $ArtifactRoot 'RELEASE_NOTES_1.2.26.md'
$CanonicalNotes = Join-Path $Repo 'docs\maintainers\RELEASE_NOTES_1.2.26.md'
