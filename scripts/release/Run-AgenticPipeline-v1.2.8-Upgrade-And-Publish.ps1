...
$LocalScript = Join-Path $PSScriptRoot 'Run-AgenticPipeline-v1.2.8-Upgrade-Local.ps1'
...
try {
  $PublishScript = Join-Path $PSScriptRoot 'Publish-AgenticPipeline-v1.2.8-GitHub.ps1'
