...
Set-StrictMode -Version 3.0;$ErrorActionPreference='Stop';$Root=(Resolve-Path -LiteralPath $RepoRoot).Path;$Expected='1.2.20'
...
foreach($Path in @('docs\companion\00_AGENTIC_PIPELINE_INDEX_v1.2.20.md','docs\companion\01_PROJECT_INSTRUCTIONS_v1.2.20.md','docs\companion\02_AGENT_TASK_PACK_CONTRACT_v1.2.20.md','docs\companion\SYSTEM_PROMPT_GPT56_COMPANION_v1.2.20.md','scripts\windows\companion\Build-CompanionPack-v1.2.20.ps1','scripts\windows\Build-AgenticProjectRuntimeOverlay-v1.2.20.ps1','scripts\bridge\Build-CompanionActionBridgePackage-v1.2.20.ps1','integrations\companion-handoff-1.2.20\Build-AgenticContextHandoffPackage-v1.2.20.ps1')){if(!(Test-Path (Join-Path $Root $Path)-PathType Leaf)){throw "Unified active file missing: $Path"}}
