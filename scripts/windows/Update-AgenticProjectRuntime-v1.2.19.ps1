...
$TransactionId = 'runtime-1.2.19-' + [Guid]::NewGuid().ToString('N')
...
if ($AlreadyCurrent) {
  ...
  Write-Host 'PROJECT RUNTIME 1.2.19 ALREADY CURRENT; VERIFICATION-ONLY RUN PASSED.' -ForegroundColor Green
  return
}
