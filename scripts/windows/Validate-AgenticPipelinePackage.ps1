...
$required = @(
 ...
 "docs/companion/SYSTEM_PROMPT_GPT56_COMPANION_v1.2.26.md","docs/companion/00_AGENTIC_PIPELINE_INDEX_v1.2.26.md","docs/companion/01_PROJECT_INSTRUCTIONS_v1.2.26.md","docs/companion/02_AGENT_TASK_PACK_CONTRACT_v1.2.26.md","docs/companion/14_AUTONOMOUS_CONVERGENCE_AND_AUDIT_COVERAGE.md","docs/companion/15_OWNER_OUTPUT_PRESENTATION.md",
 ...
 "evals/companion/golden_cases.json","evals/companion/flow_restoration_cases.json","evals/companion/autonomous_convergence_cases.json","scripts/companion/companion-control.cjs","scripts/control-plane/autonomous-convergence.cjs","scripts/control-plane/progress-guard.cjs","scripts/control-plane/validate-findings.cjs","scripts/control-plane/action-packet.cjs","tests/acceptance/autonomous-convergence-contract.cjs","scripts/windows/companion/Test-CompanionPack-v1.2.26.ps1","scripts/windows/companion/Test-FlowRestorationContracts.ps1","scripts/windows/companion/Test-AutonomousConvergenceContracts.ps1",
 "scripts/windows/Test-OwnerAutonomyContracts.ps1","scripts/windows/Test-UnifiedEcosystemVersion.ps1","scripts/windows/Test-OperationalDeployment.ps1","scripts/windows/Test-KnownFailureRegressionPlaybook-v1.2.26.ps1","scripts/windows/Test-FinalizationWindowsRegressions.ps1","scripts/windows/Build-AgenticProjectRuntimeOverlay-v1.2.26.ps1","scripts/windows/Update-AgenticProjectRuntime-v1.2.26.ps1","scripts/windows/common/NativeProcess.ps1","scripts/release/Apply-CandidateOverlay.ps1","scripts/bridge/companion_action_bridge.py","scripts/bridge/Install-CompanionActionBridge.ps1","scripts/bridge/Build-CompanionActionBridgePackage-v1.2.26.ps1","templates/agy-project-base/.agents/hooks.json","templates/agy-project-base/.agents/hooks/agentic_runtime_hook.cjs","templates/agy-project-base/scripts/windows/common/NativeProcess.ps1","templates/agy-project-base/.agy/PROGRESS_POLICY.json","templates/agy-project-base/.agy/PROGRESS_STATE.json","templates/agy-project-base/.agy/NEXT_ACTION.json","templates/agy-project-base/.agy/CANDIDATE_MANIFEST_STATUS.json",
 "tests/regression/KNOWN_FAILURE_PLAYBOOK_v1.2.26.json","tests/regression/finalization-known-failure-regression.cjs","tests/acceptance/Test-CandidateOverlayEolSafety.ps1","tests/acceptance/Test-ValidationSourceImmutability.ps1","tests/acceptance/Test-RuntimeUpdaterTransaction.ps1","tests/acceptance/Test-ResultAuthorityCompilerTransaction.ps1","tests/acceptance/Test-ActionBridgeEndToEnd.ps1","tests/acceptance/Test-ActionBridgeInstallerTransaction.ps1","tests/acceptance/Test-ContextHandoffEngine.ps1","tests/acceptance/Test-ContextHandoffAssetBinding.ps1","tests/acceptance/Test-CompanionRestartHandoffRootEntry.ps1","tests/acceptance/Test-CompanionRestartSessionDelta.ps1","scripts/release/common/CompanionRestartHandoffArchive.ps1",
 "integrations/companion-handoff-1.2.26/Build-AgenticContextHandoffPackage-v1.2.26.ps1","integrations/companion-handoff-1.2.26/Update-AgenticContextHandoff-v1.2.26.ps1","integrations/companion-handoff-1.2.26/source/handoff.config.example.json","integrations/companion-handoff-1.2.26/source/TARGET_RUNTIME_BASELINE.json","integrations/companion-handoff-1.2.26/source/src/export_ag_handoff.py","integrations/companion-handoff-1.2.26/source/src/authority_collector.py",
