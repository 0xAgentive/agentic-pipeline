...
Assert-Equal -Actual $Version.package_version -Expected "1.2.14" -Message "Acceptance requires package 1.2.14 candidate."
Assert-Equal -Actual $Version.runtime_version -Expected "1.2.14" -Message "Acceptance requires runtime 1.2.14."
Assert-Equal -Actual $Version.companion_version -Expected "1.2.14" -Message "Acceptance requires Companion 1.2.14."
...
foreach ($InstallerContract in @(
  ...
  foreach ($ForbiddenLiteral in @('"1.2.6"', '"1.2.3"', '"1.2.9"', '"1.2.10"', '"1.2.11"', '"1.2.12"', '"1.2.13"', '"1.2.14"')) {
