...
Assert-Equal -Actual $Version.package_version -Expected "1.2.23" -Message "Acceptance requires package 1.2.23 candidate."
Assert-Equal -Actual $Version.runtime_version -Expected "1.2.23" -Message "Acceptance requires runtime 1.2.23."
Assert-Equal -Actual $Version.companion_version -Expected "1.2.23" -Message "Acceptance requires Companion 1.2.23."
